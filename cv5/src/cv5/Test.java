...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        while (run) {
            ...
            System.out.println("6 .. vypis cele databaze");
            System.out.println("7 .. ulozeni databaze do souboru");
            System.out.println("8 .. nacteni databaze ze souboru");
            ...
            switch (volba) {
                ...
                case 6:
                    // výpis celé databáze
                    mojeDatabaze.vypisVse();
                    break;

                case 7:
                    // uložení databáze do souboru
                    System.out.println("Zadejte nazev souboru pro ulozeni:");
                    String nazevUloz = sc.next();
                    try {
                        mojeDatabaze.ulozDoSouboru(nazevUloz);
                        System.out.println("Databaze ulozena.");
                    } catch (FileNotFoundException e) {
                        System.out.println("Soubor se nepodarilo otevrit pro zapis: " + e.getMessage());
                    }
                    break;

                case 8:
                    // načtení databáze ze souboru
                    System.out.println("Zadejte nazev souboru pro nacitani:");
                    String nazevNacti = sc.next();
                    try {
                        mojeDatabaze.nactiZeSouboru(nazevNacti);
